...
import 'package:ge_wb_app/widgets/number_text_field_widget.dart';
...
class LoginPick extends StatefulWidget {
  const LoginPick({super.key, required this.isReLogin, this.reLoginCallBack});

  final bool isReLogin;
  final Function(UserInfo)? reLoginCallBack;
...
class _LoginPickState extends State<LoginPick>
  ...
  void initState() {
    ...
    logic.reLogin=widget.reLoginCallBack;
    super.initState();
  }
