...
import 'package:ge_wb_app/db/bar_code.dart';
import 'package:ge_wb_app/do_http/response/jpush_notification.dart';
...
import 'package:ge_wb_app/web_builder.dart';
...
UserInfo? userInfo() =>AppInitService.to.userInfo;

void setUserInfo(UserInfo ui) =>AppInitService.to.userInfo=ui;
...
class AppInitService extends GetxService {
  ...
  Future<void> _initializeApp() async {
    try {
      ...
      // Get.offAll(() => userInfo == null ? const LoginPage() : const WebBuilder());
      Get.offAll(() => const WebBuilder());
    }
  }

  initDatabase() async {
    var path = await getDatabasesPath();
    openDatabase(join(path, jdDatabase), version: 1, onCreate: (db, v) {
